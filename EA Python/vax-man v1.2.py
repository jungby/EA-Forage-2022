...
def startGame():
  ...
  Blinky = Ghost( w, b_h, "images/tokill_Ghost.png" , "Blinky" )
  monsta_list.add(Blinky)
  all_sprites_list.add(Blinky)

  Pinky = Ghost( w, m_h, "images/tokill_Ghost.png" , "Pinky" )
  monsta_list.add(Pinky)
  all_sprites_list.add(Pinky)
   
  Inky = Ghost( i_w, m_h, "images/tokill_Ghost.png" , "Inky" )
  monsta_list.add(Inky)
  all_sprites_list.add(Inky)
   
  Clyde = Ghost( c_w, m_h, "images/tokill_Ghost.png" , "Clyde" )
  ...
  while done == False:
      ...
      for ghost in monsta_list:
        ...
        if (ghost.spawn_time > 30):
          ghost.spawn_time = 0
          NewGhost = Ghost( w, m_h, "images/tokill_Ghost.png" , "Pinky" )

          if ghost.name == "Pinky":
            NewGhost = Ghost( w, m_h, "images/tokill_Ghost.png" , "Pinky" )
          elif ghost.name == "Blinky":
            NewGhost = Ghost( w, b_h, "images/tokill_Ghost.png" , "Blinky" )
          elif ghost.name == "Inky":
            NewGhost = Ghost( i_w, m_h, "images/tokill_Ghost.png" , "Inky" )
          elif ghost.name == "Clyde":
            NewGhost = Ghost( c_w, m_h, "images/tokill_Ghost.png" , "Clyde" )
